...
Creating a violin is expensive. It costs years to learn the craft and hours to
shape the wood. Do not use the completed violin as fuel for the fire. Do not
use it to pound in nails. Use it to play music so that it may be worthy of its
price.

Evolving humanity is expensive. It took eons to evolve the biosphere and to
deposit the vast stores of fossil fuels we depend upon. In the decades of our
infancy we have caused the extinction of myriad other species and have consumed
most of Life's densest reserves of concentrated energy. It will take a lot of
doing to become worthy of such a great price.

The extinctions we have caused and the fuels we have burned have purchased an
infrastructure that can be of great use to Life. Let us use ourselves and the
world we have built to increase Life's fund of diversity and possibility. Let
this be our prayer:

\begin{quote}
	\em
We are evolution's violin.\\
\tab Realize how fine and expensive we are.\\
\\
Life believes in us, depends on us, calls us.\\
\tab Heed the call, be worthy of the price.
\end{quote}
