...
\noindent Within the crucible of our time and place a Truth, Beauty, and Values
movement coalesces. This movement automatically includes all people and groups
of people who agree with the following three assertions:

\begin{enumerate}
  \item Science is how reality is uncovered.
  \item Life is precious and beautiful.
  \item Pursuing Arete is the right way for individuals and groups to live.
\end{enumerate}

There exists a loose network of people and groups who are in the movement. The
network is loose in part, because the movement has not been named and
described. Inviduals and groups cannot identify with a movement that has not
been named and described, so instead join and support groups and causes that
are a subset of the movement. These subset groups tend to promote one or more
of the following elemental worldviews:

\begin{itemize}
  \item naturalism (e.g., Center for Inquiry)
  \item humanism (e.g., Amnesty international)
  \item environmentalism (e.g., the Sierra Club)
  \item pantheism (e.g., the World Pantheism Network)
  \item areteism (e.g., not sure?)
\end{itemize}

This book describes the greater movement that integrates all of these worldview
elements. The image of the greater movement presented here is derived from the
perspective of the SolSeed movement. The SolSeed movement is just one of an
unknown number of nodes within the network. Many other perspectives are
...
\noindent The cells in your body don't know who you are and don't care about you. And
